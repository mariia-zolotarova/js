...
// function t8() {
//     let inp1 = Number(document.querySelector('.i-81').value);
//     let inp2 = Number(document.querySelector('.i-82').value);
...
function t9() {
    let inp1 = Number(document.querySelector('.i-91').value);
    let inp2 = Number(document.querySelector('.i-92').value);
...
function t11() {
    ...
    // let divs = [div11, div11, div11, div11]
...
//         out.textContent += ` ${elem[i].innerHTML}.style.background = 'orange'`;
//     }
