...
document.querySelector('.out-7').textContent = e3 * f4
...
function t9() {
    let data2 = document.querySelector('.i-9').value;
    let out2 = document.querySelector('.out-9');
    out2.textContent = data2;
...
function t10() {
    let data3 = document.querySelector('.i-10').value;
    let out3 = document.querySelector('.out-10');

    out3.textContent = data3 * 20;
...
function t11() {
    let data4 = document.querySelector('.i-11').value;
    let out4 = document.querySelector('.out-11');

    out4.textContent = +data4 + 55;
...
function t12() {
    ...
    let out5 = document.querySelector('.out-12');
    // out5.textContent = "Hello " + inp1 + " " + inp2;
    out5.textContent = `Hello ${inp1}  ${inp2}`
}
...
function t13() {
    let inp1 = document.querySelector('.i-13-1').value;
    let inp2 = document.querySelector('.i-13-2').value;
    let res = Number(inp1) + Number(inp2)
...
function t19() {
    let inp1 = document.querySelector('.i-19-1').value;
    let inp2 = document.querySelector('.i-19-2').value;
    let res = Number(inp1) + Number(inp2)
...
function t20() {
    ...
    // let out20 = document.querySelector('.b-20').onclick = count
